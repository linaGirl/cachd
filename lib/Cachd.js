!function() {
    ...
    classDefinition = {
        ...
        // how many ms to wait between ttl checks
        , ttlCheckFrequency: 30000
        ...
        , init: function(options) {
            ...
            // set up ttl check
            setInterval(this._removeOutdatedNodes.bind(this), this.ttlCheckFrequency);
        }
         ...
         */
        , getLast: function() {
            if (this.removalStrategy === 'leastUsed') return this.ageList.length ? this.ageList.getLast().value : null;
            else return this.ttlList.length ? this.ttlList.getLast().value : null;
        }
         ...
         */
        , getFirst: function() {
            if (this.removalStrategy === 'leastUsed') return this.ageList.length ? this.ageList.getFirst().value : null;
            else return this.ttlList.length ? this.ttlList.getFirst().value : null;
        }
